...
public class Jugador {
    ...
    //Metodo que agarra una carta de la mano del jugador y la saca de su mano
    public Carta agarrarCarta(int numeroCarta){
        return mano.remove(numeroCarta);
    }
    //EL JUGADOR MOSTRARA SU MANO;
    public void imprimirMano() {
    for (int i = 0; i < mano.size(); i++) {
        System.out.print((i+1) + ". " + mano.get(i).toString()+"\n");
    }
}
    //Metodo que le permite elegir una carta de su mano al jugador y utilizarla
